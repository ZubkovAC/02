...
test('correct task should be deleted from correct array', () => {
    ...
    const endState = tasksReducer(startState, removeTask("2", "todolistId2"))
...
test('correct task should be added to correct array', () => {
    ...
    const action = addTasks("juce", "todolistId2");


    const endState = tasksReducer(startState, addTasks("juce", "todolistId2"))
...
test('title of specified task should be changed', () => {
    ...
    const action = newTitleTask("MUMO", "todolistId2","3" );
